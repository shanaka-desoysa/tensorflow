...
LOG_FILE = 'logs/vectorized_graph'
...
with graph.as_default():
    ...
    with tf.name_scope("variables"):
        ...
        previous_value = tf.Variable(
            0.0, dtype=tf.float32, name="previous_value")
...
def run_graph(input_tensor):
    ...
    output, summary, step = sess.run(
        [update_prev, merged_summaries, increment_step], feed_dict=feed_dict)
